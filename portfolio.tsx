  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-slide-in-left">
              ...
              <div className="flex flex-wrap gap-3">
                <Badge
                  className="hover:opacity-80 transition-all duration-300 transform hover:scale-110 animate-bounce-in"
                  style={{ backgroundColor: "#F5DEB3", color: "#001a4d", animationDelay: "0.1s" }}
                >
                  Problem Solver
                </Badge>
                <Badge
                  className="hover:opacity-80 transition-all duration-300 transform hover:scale-110 animate-bounce-in"
                  style={{ backgroundColor: "#D4AF37", color: "#001a4d", animationDelay: "0.2s" }}
                >
                  Team Player
                </Badge>
                <Badge
                  className="hover:opacity-80 transition-all duration-300 transform hover:scale-110 animate-bounce-in"
                  style={{ backgroundColor: "#F5DEB3", color: "#001a4d", animationDelay: "0.3s" }}
                >
                  Quick Learner
                </Badge>
                <Badge
                  className="hover:opacity-80 transition-all duration-300 transform hover:scale-110 animate-bounce-in"
                  style={{ backgroundColor: "#D4AF37", color: "#001a4d", animationDelay: "0.4s" }}
                >
                  Detail Oriented
                </Badge>
              </div>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <h2
            className="text-3xl md:text-4xl font-bold text-center mb-4 animate-fade-in-up"
            style={{ color: "#001a4d" }}
          >
            Skills & Technologies
          </h2>
          <p
            className="text-center text-gray-600 mb-12 max-w-2xl mx-auto animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {skills.map((category, categoryIndex) => {
              ...
              return (
                <Card
                  key={categoryIndex}
                  className="group hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-4 hover:rotate-1 border-0 shadow-lg bg-white/90 backdrop-blur-sm animate-slide-in-up"
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className="group hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-6 hover:rotate-2 border-0 shadow-lg overflow-hidden animate-slide-in-up"
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map((tag, tagIndex) => (
                      <Badge
                        key={tagIndex}
                        className="text-xs transition-all duration-300 transform hover:scale-110 animate-bounce-in"
                        style={{
      ...
      >
        <div className="absolute inset-0">
          <div className="absolute top-20 right-10 w-40 h-40 bg-[#D4AF37]/10 rounded-full animate-pulse"></div>
          <div
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="space-y-8">
            <Card className="hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-2 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm animate-slide-in-up">
              <CardHeader>
      ...
      >
        <div className="absolute inset-0">
          <div className="absolute top-10 left-1/4 w-20 h-20 bg-[#D4AF37]/20 rounded-full animate-float"></div>
          <div
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 animate-fade-in-up">Let's Work Together</h2>
          <p
            className="text-xl text-blue-50 mb-8 max-w-2xl mx-auto animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
          ...
          <Button
            size="lg"
            className="font-semibold shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-110 hover:-translate-y-2 border-0 animate-pulse-slow"
            style={{
              background: "linear-gradient(45deg, #FFD700, #B8860B)",
              color: "#001a4d",
            }}
